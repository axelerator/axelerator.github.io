...
var $author$project$Interactive$ForFeatures = function (a) {
	return {$: 'ForFeatures', a: a};
};
var $author$project$Interactive$OnFeatureTree = function (a) {
	return {$: 'OnFeatureTree', a: a};
};
var $author$project$Interactive$OnFeatures = function (a) {
	return {$: 'OnFeatures', a: a};
};
var $author$project$Interactive$OnSubscribe = function (a) {
	return {$: 'OnSubscribe', a: a};
};
var $author$project$Interactive$OnUnsubscribe = function (a) {
	return {$: 'OnUnsubscribe', a: a};
};
var $author$project$Interactive$OnVariants = function (a) {
	return {$: 'OnVariants', a: a};
};
var $author$project$Interactive$InitFeatureTree = {$: 'InitFeatureTree'};
var $author$project$Interactive$InitFeatures = function (a) {
	return {$: 'InitFeatures', a: a};
};
var $author$project$Interactive$InitSubscribe = {$: 'InitSubscribe'};
var $author$project$Interactive$InitUnsubscribe = function (a) {
	return {$: 'InitUnsubscribe', a: a};
};
var $author$project$Interactive$InitVariants = function (a) {
	return {$: 'InitVariants', a: a};
};
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $elm$json$Json$Decode$fail = _Json_fail;
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Interactive$decodeFlags = A2(
		...
		switch (kind) {
			case 'Variants':
				return A2(
					...
					$author$project$Interactive$InitVariants,
					A2($elm$json$Json$Decode$field, 'lang', $elm$json$Json$Decode$string));
			case 'Features':
				return A2(
					$elm$json$Json$Decode$map,
					$author$project$Interactive$InitFeatures,
					A2($elm$json$Json$Decode$field, 'lang', $elm$json$Json$Decode$string));
			case 'FeatureTree':
				return $elm$json$Json$Decode$succeed($author$project$Interactive$InitFeatureTree);
			case 'Subscribe':
				return $elm$json$Json$Decode$succeed($author$project$Interactive$InitSubscribe);
			case 'Unsubscribe':
				return A2(
					$elm$json$Json$Decode$map,
					$author$project$Interactive$InitUnsubscribe,
					A2($elm$json$Json$Decode$field, 'email', $elm$json$Json$Decode$string));
			default:
				return $elm$json$Json$Decode$fail('Unknown variant: ' + kind);
		}
	},
	A2($elm$json$Json$Decode$field, 'kind', $elm$json$Json$Decode$string));
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $author$project$FeatureTree$init = _Utils_Tuple0;
var $author$project$Features$Loading = {$: 'Loading'};
var $BrianHicks$elm_csv$Csv$Decode$NoFieldNames = {$: 'NoFieldNames'};
...
var $author$project$Features$decoder = A2(
	$BrianHicks$elm_csv$Csv$Decode$pipeline,
	A2($BrianHicks$elm_csv$Csv$Decode$column, 1, $BrianHicks$elm_csv$Csv$Decode$int),
	A2(
		$BrianHicks$elm_csv$Csv$Decode$pipeline,
		A2(
			$BrianHicks$elm_csv$Csv$Decode$map,
			$elm$core$String$split('-'),
			A2($BrianHicks$elm_csv$Csv$Decode$column, 0, $BrianHicks$elm_csv$Csv$Decode$string)),
		$BrianHicks$elm_csv$Csv$Decode$into(
			F2(
				function (sequence, count) {
					return {sequence: sequence, visits: count};
				}))));
...
var $author$project$Features$ttt = A2(
			...
			function (d) {
				return {
					category: A2(
						$elm$core$Maybe$withDefault,
						'end',
						$elm_community$list_extra$List$Extra$last(d.sequence)),
					sequence: d.sequence,
					visits: d.visits
				};
			}),
			...
			F3(
				function (_v0, a, b) {
					return A2(
						...
						$gampleman$elm_rosetree$Tree$label(b).visits,
						$gampleman$elm_rosetree$Tree$label(a).visits);
				}))));
var $author$project$Features$convertCsv = function (csv) {
	var decodeResult = A3($BrianHicks$elm_csv$Csv$Decode$decodeCsv, $BrianHicks$elm_csv$Csv$Decode$NoFieldNames, $author$project$Features$decoder, csv);
	if (decodeResult.$ === 'Ok') {
		var res = decodeResult.a;
		var t1 = A2(
			...
			res);
		if (t1.$ === 'Err') {
			return $elm$core$Result$Err('err on t1');
		} else {
			var t = t1.a;
			return $elm$core$Result$Ok(
				$author$project$Features$ttt(t));
		}
	} else {
		return $elm$core$Result$Err('bang!');
	}
};
var $author$project$Features$featuresStr = 'retrieval-tags,3\nretrieval-sender,3\nretrieval-search,3\nproductivity-tasks-workflows,6\naccess-privacy-sbc,3\naccess-mobile-native,3\naccess-backup-cloud,3\naccess-backup-usb,3';
var $author$project$Features$Loaded = function (a) {
	return {$: 'Loaded', a: a};
};
...
var $gampleman$elm_visualization$Scale$Color$lightOrangeInterpolator = $gampleman$elm_visualization$Scale$Color$mkPiecewiseInterpolator('f2e7daf7d5baf9c499fab184fa9c73f68967ef7860e8645bde515bd43d5b');
...
var $author$project$Features$h = 500;
var $elm$core$Basics$min = F2(
	function (x, y) {
		return (_Utils_cmp(x, y) < 0) ? x : y;
	});
var $author$project$Features$w = 500;
var $author$project$Features$radius = A2($elm$core$Basics$min, $author$project$Features$w, $author$project$Features$h) / 2;
...
var $gampleman$elm_visualization$Scale$Color$tealInterpolator = $gampleman$elm_visualization$Scale$Color$mkPiecewiseInterpolator('bbdfdfa2d4d58ac9c975bcbb61b0af4da5a43799982b8b8c1e7f7f127273006667');
...
var $gampleman$elm_visualization$Scale$Color$warmGreysInterpolator = $gampleman$elm_visualization$Scale$Color$mkPiecewiseInterpolator('dcd4d0cec5c1c0b8b4b3aaa7a59c9998908c8b827f7e7673726866665c5a59504e');
var $author$project$Features$loadData = F2(
	function (rawData, lang) {
		var gradients = _List_fromArray(
			[$gampleman$elm_visualization$Scale$Color$tealInterpolator, $gampleman$elm_visualization$Scale$Color$lightOrangeInterpolator, $gampleman$elm_visualization$Scale$Color$warmGreysInterpolator]);
		var f = F4(
			function (_v6, ancestors, l, c) {
				var currentTop = _v6.a;
				var mapping = _v6.b;
				if (ancestors.b && (!ancestors.b.b)) {
					var asS = _Utils_Tuple3(
						currentTop + 1,
						$elm$core$List$length(ancestors),
						A2($elm$core$String$join, '-', l.sequence));
					return $gampleman$elm_rosetree$Tree$Continue(
						_Utils_Tuple2(
							currentTop + 1,
							A2($elm$core$List$cons, asS, mapping)));
				} else {
					var asS = _Utils_Tuple3(
						currentTop,
						$elm$core$List$length(ancestors),
						A2(
							...
							'missing',
							$elm$core$List$head(
								$elm$core$List$reverse(l.sequence))));
					return $gampleman$elm_rosetree$Tree$Continue(
						_Utils_Tuple2(
							currentTop,
							A2($elm$core$List$cons, asS, mapping)));
		...
		var depth = $gampleman$elm_rosetree$Tree$depth(rawData);
		var labelWithColor = function (_v4) {
			var top = _v4.a;
			var d = _v4.b;
			var label = _v4.c;
			var gradient = A2(
				$elm$core$Maybe$withDefault,
				$gampleman$elm_visualization$Scale$Color$tealInterpolator,
				$elm$core$List$head(
					A2($elm$core$List$drop, top, gradients)));
			var depthFloat = d / depth;
			return _Utils_Tuple2(
				label,
				gradient(depthFloat));
		};
		var colorMapping = A2(
			...
			A3(
				...
				rawData).b);
		var labelsWithColors = A2($elm$core$List$map, labelWithColor, colorMapping);
		var categories = A3(
			$gampleman$elm_rosetree$Tree$foldl,
			F2(
				function (_v3, set) {
					var sequence = _v3.sequence;
					return A2(
						$elm$core$Set$union,
						set,
						$elm$core$Set$fromList(sequence));
				}),
			$elm$core$Set$empty,
			rawData);
		var _v0 = A3(
		...
		var labels = _v0.a;
		var colors = _v0.b;
		var colorScale = A2($gampleman$elm_visualization$Scale$ordinal, colors, labels);
		return $author$project$Features$Loaded(
			{
				categories: labels,
					...
					$elm$core$List$tail(
						$gampleman$elm_rosetree$Tree$toList(
							A3(
								...
								_List_fromArray(
									[
										A2($gampleman$elm_visualization$Hierarchy$size, 2 * $elm$core$Basics$pi, $author$project$Features$radius * $author$project$Features$radius)
									]),
								A2(
									$elm$core$Basics$composeR,
									function ($) {
								...
								A2($elm$core$Debug$log, 'rawData', rawData))))),
				total: $gampleman$elm_rosetree$Tree$label(rawData).visits
			});
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Features$init = function (lang) {
	return _Utils_Tuple2(
		function () {
			var _v0 = $author$project$Features$convertCsv($author$project$Features$featuresStr);
			if (_v0.$ === 'Ok') {
				var rawData = _v0.a;
				return A2($author$project$Features$loadData, rawData, lang);
			} else {
				return $author$project$Features$Loading;
			}
		}(),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Subscribe$Input = function (a) {
	return {$: 'Input', a: a};
};
var $author$project$Subscribe$init = $author$project$Subscribe$Input('');
var $author$project$Unsubscribe$Input = function (a) {
	return {$: 'Input', a: a};
};
var $author$project$Unsubscribe$init = function (email) {
	return $author$project$Unsubscribe$Input(email);
};
var $author$project$Variants$Pi = function (a) {
	return {$: 'Pi', a: a};
};
var $author$project$Variants$init = function (lang) {
	return {
		count: 0,
		lang: lang,
		_package: $author$project$Variants$Pi(false)
	};
};
var $elm$core$Platform$Cmd$map = _Platform_map;
var $author$project$Interactive$init = function (v) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Interactive$decodeFlags, v);
	if (_v0.$ === 'Ok') {
		switch (_v0.a.$) {
			case 'InitVariants':
				var lang = _v0.a.a;
				return _Utils_Tuple2(
					$author$project$Interactive$OnVariants(
						$author$project$Variants$init(lang)),
					$elm$core$Platform$Cmd$none);
			case 'InitFeatureTree':
				var _v1 = _v0.a;
				return _Utils_Tuple2(
					$author$project$Interactive$OnFeatureTree($author$project$FeatureTree$init),
					$elm$core$Platform$Cmd$none);
			case 'InitFeatures':
				var lang = _v0.a.a;
				var _v2 = $author$project$Features$init(lang);
				var m = _v2.a;
				var c = _v2.b;
				return _Utils_Tuple2(
					$author$project$Interactive$OnFeatures(m),
					A2($elm$core$Platform$Cmd$map, $author$project$Interactive$ForFeatures, c));
			case 'InitSubscribe':
				var _v3 = _v0.a;
				return _Utils_Tuple2(
					$author$project$Interactive$OnSubscribe($author$project$Subscribe$init),
					$elm$core$Platform$Cmd$none);
			default:
				var email = _v0.a.a;
				return _Utils_Tuple2(
					$author$project$Interactive$OnUnsubscribe(
						$author$project$Unsubscribe$init(email)),
					$elm$core$Platform$Cmd$none);
		}
	} else {
		return _Utils_Tuple2(
			$author$project$Interactive$OnVariants(
				$author$project$Variants$init('en')),
			$elm$core$Platform$Cmd$none);
	}
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Interactive$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Interactive$ForFeatureTree = function (a) {
	return {$: 'ForFeatureTree', a: a};
};
var $author$project$Interactive$ForSubscribe = function (a) {
	return {$: 'ForSubscribe', a: a};
};
var $author$project$Interactive$ForUnsubscribe = function (a) {
	return {$: 'ForUnsubscribe', a: a};
};
var $author$project$Interactive$ForVariants = function (a) {
	return {$: 'ForVariants', a: a};
};
var $author$project$FeatureTree$update = F2(
	function (_v0, model) {
...
var $author$project$Features$update = F2(
	function (msg, model) {
		...
		if (_v0.b.$ === 'Loaded') {
			...
			var mod = _v0.b.a;
			return _Utils_Tuple2(
				$author$project$Features$Loaded(
					_Utils_update(
						mod,
						{hovered: hover})),
				$elm$core$Platform$Cmd$none);
...
var $author$project$Subscribe$Failure = {$: 'Failure'};
var $author$project$Subscribe$Pending = function (a) {
	return {$: 'Pending', a: a};
};
var $author$project$Subscribe$Success = {$: 'Success'};
var $author$project$Subscribe$GotSubscriptionResponse = function (a) {
	return {$: 'GotSubscriptionResponse', a: a};
};
...
var $author$project$Subscribe$subscriptionEncoder = function (email) {
...
var $author$project$Subscribe$postSubscription = function (email) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$Subscribe$subscriptionEncoder(email)),
			expect: $elm$http$Http$expectWhatever($author$project$Subscribe$GotSubscriptionResponse),
			url: 'https://newsletter.axelerator.de/subscribe'
		});
};
var $author$project$Subscribe$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ChangeEmail':
				var email = msg.a;
				return _Utils_Tuple2(
					$author$project$Subscribe$Input(email),
					$elm$core$Platform$Cmd$none);
			case 'Submit':
				var email = function () {
					if (model.$ === 'Input') {
				...
				return _Utils_Tuple2(
					$author$project$Subscribe$Pending(email),
					$author$project$Subscribe$postSubscription(email));
			default:
				var res = msg.a;
				if (res.$ === 'Err') {
					return _Utils_Tuple2($author$project$Subscribe$Failure, $elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2($author$project$Subscribe$Success, $elm$core$Platform$Cmd$none);
				}
		}
	});
var $author$project$Unsubscribe$Failure = {$: 'Failure'};
var $author$project$Unsubscribe$Pending = function (a) {
	return {$: 'Pending', a: a};
};
var $author$project$Unsubscribe$Success = {$: 'Success'};
var $author$project$Unsubscribe$GotSubscriptionResponse = function (a) {
	return {$: 'GotSubscriptionResponse', a: a};
};
var $author$project$Unsubscribe$subscriptionEncoder = function (email) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Unsubscribe$postSubscription = function (email) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$Unsubscribe$subscriptionEncoder(email)),
			expect: $elm$http$Http$expectWhatever($author$project$Unsubscribe$GotSubscriptionResponse),
			url: 'https://newsletter.axelerator.de/unsubscribe'
		});
};
var $author$project$Unsubscribe$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ChangeEmail':
				var email = msg.a;
				return _Utils_Tuple2(
					$author$project$Unsubscribe$Input(email),
					$elm$core$Platform$Cmd$none);
			case 'Submit':
				var email = function () {
					if (model.$ === 'Input') {
				...
				return _Utils_Tuple2(
					$author$project$Unsubscribe$Pending(email),
					$author$project$Unsubscribe$postSubscription(email));
			default:
				var res = msg.a;
				if (res.$ === 'Err') {
					return _Utils_Tuple2($author$project$Unsubscribe$Failure, $elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2($author$project$Unsubscribe$Success, $elm$core$Platform$Cmd$none);
				}
		}
	});
var $author$project$Variants$Operator = {$: 'Operator'};
var $author$project$Variants$SaaS = {$: 'SaaS'};
var $author$project$Variants$update = F2(
	function (msg, model) {
		if (msg.$ === 'Increment') {
			return _Utils_Tuple2(
				_Utils_update(
			...
			var _package = function () {
				switch (s) {
					case '0':
						return $author$project$Variants$Operator;
					case '1':
						return $author$project$Variants$Pi(false);
					default:
						return $author$project$Variants$SaaS;
				}
			}();
			return _Utils_Tuple2(
				_Utils_update(
...
var $author$project$Interactive$update = F2(
	function (msg, model) {
		var _v0 = _Utils_Tuple2(msg, model);
		_v0$5:
		while (true) {
			switch (_v0.a.$) {
				case 'ForVariants':
					if (_v0.b.$ === 'OnVariants') {
						var msg_ = _v0.a.a;
						var model_ = _v0.b.a;
						var _v1 = A2($author$project$Variants$update, msg_, model_);
						var model__ = _v1.a;
						var cmd = _v1.b;
						return _Utils_Tuple2(
							$author$project$Interactive$OnVariants(model__),
							A2($elm$core$Platform$Cmd$map, $author$project$Interactive$ForVariants, cmd));
					} else {
						break _v0$5;
					}
				case 'ForFeatureTree':
					if (_v0.b.$ === 'OnFeatureTree') {
						var msg_ = _v0.a.a;
						var model_ = _v0.b.a;
						var _v2 = A2($author$project$FeatureTree$update, msg_, model_);
						var model__ = _v2.a;
						var cmd = _v2.b;
						return _Utils_Tuple2(
							$author$project$Interactive$OnFeatureTree(model__),
							A2($elm$core$Platform$Cmd$map, $author$project$Interactive$ForFeatureTree, cmd));
					} else {
						break _v0$5;
					}
				case 'ForFeatures':
					if (_v0.b.$ === 'OnFeatures') {
						var msg_ = _v0.a.a;
						var model_ = _v0.b.a;
						var _v3 = A2($author$project$Features$update, msg_, model_);
						var model__ = _v3.a;
						var cmd = _v3.b;
						return _Utils_Tuple2(
							$author$project$Interactive$OnFeatures(model__),
							A2($elm$core$Platform$Cmd$map, $author$project$Interactive$ForFeatures, cmd));
					} else {
						break _v0$5;
					}
				case 'ForSubscribe':
					if (_v0.b.$ === 'OnSubscribe') {
						var msg_ = _v0.a.a;
						var model_ = _v0.b.a;
						var _v4 = A2($author$project$Subscribe$update, msg_, model_);
						var model__ = _v4.a;
						var cmd = _v4.b;
						return _Utils_Tuple2(
							$author$project$Interactive$OnSubscribe(model__),
							A2($elm$core$Platform$Cmd$map, $author$project$Interactive$ForSubscribe, cmd));
					} else {
						break _v0$5;
					}
				default:
					if (_v0.b.$ === 'OnUnsubscribe') {
						var msg_ = _v0.a.a;
						var model_ = _v0.b.a;
						var _v5 = A2($author$project$Unsubscribe$update, msg_, model_);
						var model__ = _v5.a;
						var cmd = _v5.b;
						return _Utils_Tuple2(
							$author$project$Interactive$OnUnsubscribe(model__),
							A2($elm$core$Platform$Cmd$map, $author$project$Interactive$ForUnsubscribe, cmd));
					} else {
						break _v0$5;
					}
			}
...
var $author$project$FeatureTree$featureTree = A2(
	$gampleman$elm_rosetree$Tree$tree,
	$avh4$elm_color$Color$red,
	_List_fromArray(
		[
			A2($gampleman$elm_rosetree$Tree$tree, $avh4$elm_color$Color$blue, _List_Nil),
			A2($gampleman$elm_rosetree$Tree$tree, $avh4$elm_color$Color$green, _List_Nil)
		]));
var $author$project$FeatureTree$radius = 15;
var $author$project$FeatureTree$layout = $gampleman$elm_rosetree$Tree$toList(
	A3(
		$gampleman$elm_visualization$Hierarchy$partition,
		_List_fromArray(
			[
				A2($gampleman$elm_visualization$Hierarchy$size, 2 * $elm$core$Basics$pi, $author$project$FeatureTree$radius * $author$project$FeatureTree$radius)
			]),
		function (n) {
			return 23;
		},
		$author$project$FeatureTree$featureTree));
...
var $author$project$FeatureTree$arc = function (s) {
	return $gampleman$elm_visualization$Shape$arc(
		{
			...
			padAngle: 1 / $author$project$FeatureTree$radius,
			padRadius: $author$project$FeatureTree$radius,
			startAngle: s.x
		});
};
...
var $author$project$FeatureTree$toPath = function (d) {
	return A2(
		$folkertdev$one_true_path_experiment$Path$element,
		$author$project$FeatureTree$arc(d),
		_List_fromArray(
			[
				$elm_community$typed_svg$TypedSvg$Attributes$fill(
				$elm_community$typed_svg$TypedSvg$Types$Paint(d.node))
			]));
};
...
var $author$project$FeatureTree$view = function (model) {
	return A2(
		$elm_community$typed_svg$TypedSvg$svg,
		_List_fromArray(
			[
				A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, -50, -25, 100, 50),
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$FeatureTree$toPath,
					A2($elm$core$Debug$log, 'layout', $author$project$FeatureTree$layout)))
			]));
};
...
var $elm_community$typed_svg$TypedSvg$Types$Num = function (a) {
	return {$: 'Num', a: a};
};
...
var $author$project$Features$arc = function (s) {
	return $gampleman$elm_visualization$Shape$arc(
		{
			cornerRadius: 0,
			endAngle: s.x + s.width,
			innerRadius: $elm$core$Basics$sqrt(s.y),
			outerRadius: $elm$core$Basics$sqrt(s.y + s.height) - 1,
			padAngle: 1 / $author$project$Features$radius,
			padRadius: $author$project$Features$radius,
			startAngle: s.x
		});
};
...
var $author$project$Features$featureDescription = function (sequence) {
	_v0$15:
	while (true) {
		if (sequence.b) {
			if (!sequence.b.b) {
				switch (sequence.a) {
					case 'retrieval':
						return {body: 'Features that help the user to find and open uploaded documents efficiently', title: 'Document retrieval'};
					case 'productivity':
						return {body: 'Features that help users with follow up work that involves a document after it has been uploaded', title: 'Productivity'};
					case 'access':
						return {body: 'Features that enable users to continue to access their documents or add new channels to access them.', title: 'Access'};
					default:
						break _v0$15;
				}
			} else {
				if (!sequence.b.b.b) {
					switch (sequence.a) {
						case 'retrieval':
							switch (sequence.b.a) {
								case 'tags':
									var _v1 = sequence.b;
									return {body: 'Allow users to add tags to documents and enable search by tags', title: 'Tagging'};
								case 'sender':
									var _v2 = sequence.b;
									return {body: 'Senders in documents get autodected or can be added by hand to new documents. Documents can be listed and searched by sender.', title: 'Sender detection'};
								case 'search':
									var _v3 = sequence.b;
									return {body: 'A search for a word will bring up a list of all documents containing that word.', title: 'Fulltext search'};
								default:
									break _v0$15;
							}
						case 'productivity':
							if (sequence.b.a === 'tasks') {
								var _v4 = sequence.b;
								return {body: 'Recording follow up tasks and due dates for a particular document', title: 'Tasks'};
							} else {
								break _v0$15;
							}
						case 'access':
							switch (sequence.b.a) {
								case 'privacy':
									var _v7 = sequence.b;
									return {body: 'Features that support or enable access maintaining or imporving privacy', title: 'Privacy'};
								case 'mobile':
									var _v8 = sequence.b;
									return {body: 'Mobile website allowing users to scan & access documents with their phone', title: 'Mobile'};
								case 'backup':
									var _v13 = sequence.b;
									return {body: 'Different solutions enabling users to back up their data in case of their hosting setup breaking.', title: 'Backup'};
								default:
									break _v0$15;
							}
						default:
					...
					if (!sequence.b.b.b.b) {
						switch (sequence.a) {
							case 'productivity':
								if ((sequence.b.a === 'tasks') && (sequence.b.b.a === 'workflows')) {
									var _v5 = sequence.b;
									var _v6 = _v5.b;
									return {body: 'Define recurring chains of tasks. E.g. (Medical invoice -> Claim -> Verify claimed amount arrived )', title: 'Automated workflows'};
								} else {
									break _v0$15;
								}
							case 'access':
								switch (sequence.b.a) {
									case 'mobile':
										if (sequence.b.b.a === 'native') {
											var _v9 = sequence.b;
											var _v10 = _v9.b;
											return {body: 'Deliver the mobile web app in an native app container for a more integrated UX.', title: 'Native clients'};
										} else {
											break _v0$15;
										}
									case 'privacy':
										if (sequence.b.b.a === 'sbc') {
											var _v11 = sequence.b;
											var _v12 = _v11.b;
											return {body: 'Combined software & hardware package (i.e. Raspberry Pi) that can be used to self host without technical knowledge', title: 'Managed self hosting'};
										} else {
											break _v0$15;
										}
									case 'backup':
										switch (sequence.b.b.a) {
											case 'cloud':
												var _v14 = sequence.b;
												var _v15 = _v14.b;
												return {body: 'Support syncing an encrypted copy to another folder that\'s synced to the cloud (e.g. iCloud, DropBox)', title: 'Enrcypted cloud backup'};
											case 'usb':
												var _v16 = sequence.b;
												var _v17 = _v16.b;
												return {body: 'For a headless install: Support automatic sync to a USB storage device that gets plugged in', title: 'External plugin backup'};
											default:
												break _v0$15;
										}
									default:
	...
	return {body: '', title: 'missing'};
};
var $author$project$Features$featureDescriptionDE = function (sequence) {
	_v0$15:
	while (true) {
		if (sequence.b) {
			if (!sequence.b.b) {
				switch (sequence.a) {
					case 'retrieval':
						return {body: 'Funktionen die helfen Dokumente schnell zu finden und anzuzeigen', title: 'Dokumentenabfrage'};
					case 'productivity':
						return {body: 'Funktionen die Tätigkeiten erleichtern die ein hochgeladenes Dokument involvieren', title: 'Produktivität'};
					case 'access':
						return {body: 'Funktionen die den Zugriff auf Dokumente sicherstellen oder verbessern', title: 'Zugriff'};
					default:
						break _v0$15;
				}
			} else {
					...
					switch (sequence.a) {
						case 'retrieval':
							switch (sequence.b.a) {
								case 'tags':
									var _v1 = sequence.b;
									return {body: 'Erlaubt es Dokumente mit \'Tags\' zu versehen und sie danach aufzufinden', title: 'Tagging'};
								case 'sender':
									var _v2 = sequence.b;
									return {body: 'Automatische Erkennung von Abserndern und die Möglichkeit Dokumente nach Absendern aufzulisten', title: 'Absendererkennung'};
								case 'search':
									var _v3 = sequence.b;
									return {body: 'Eine globale Suche die alle Dokumente anzeigt die einen bestimment Begriff enthalten', title: 'Volltext-Suche'};
								default:
									break _v0$15;
							}
						case 'productivity':
							if (sequence.b.a === 'tasks') {
								var _v4 = sequence.b;
								return {body: 'Aufgaben mit Fälligkeitsdatum an ein Dokument anhängen', title: 'Aufgaben'};
							} else {
								break _v0$15;
							}
						case 'access':
							switch (sequence.b.a) {
								case 'privacy':
									var _v7 = sequence.b;
									return {body: 'Funktionen die den Zugriff für den Besitzer aber nicht für Dritte erleichtern', title: 'Datenschutz'};
								case 'mobile':
									var _v8 = sequence.b;
									return {body: 'Dokumente mit dem Smartphone über eine mobile Webseite erfassen und anzeigen', title: 'Mobile'};
								case 'backup':
									var _v13 = sequence.b;
									return {body: 'Lösungen die das sichern der Dokumente in den verschiedenen Varianten unterstützen', title: 'Backup'};
								default:
									break _v0$15;
							}
						default:
						...
						switch (sequence.a) {
							case 'productivity':
								if ((sequence.b.a === 'tasks') && (sequence.b.b.a === 'workflows')) {
									var _v5 = sequence.b;
									var _v6 = _v5.b;
									return {body: 'Definieren von Ketten von Aufgaben (Rechnung einreichen -> Beitragserstattung verifizieren)', title: 'Automtisierte Abläufe'};
								} else {
									break _v0$15;
								}
							case 'access':
								switch (sequence.b.a) {
									case 'mobile':
										if (sequence.b.b.a === 'native') {
											var _v9 = sequence.b;
											var _v10 = _v9.b;
											return {body: 'iOS/Android app für bessere UX', title: 'Native App'};
										} else {
											break _v0$15;
										}
									case 'privacy':
										if (sequence.b.b.a === 'sbc') {
											var _v11 = sequence.b;
											var _v12 = _v11.b;
											return {body: 'Kombiniertes Hard- und Softwarepaket (z.B. RaspberryPi) das zum selber Hosten ohne technisches Know-How genutzt werden kann', title: 'Managed self hosting'};
										} else {
											break _v0$15;
										}
									case 'backup':
										switch (sequence.b.b.a) {
											case 'cloud':
												var _v14 = sequence.b;
												var _v15 = _v14.b;
												return {body: 'Synchronisierung der Daten in eine vom Benutzer gewählte Lösung(e.g. iCloud, DropBox)', title: 'Verschlüsseltes Cloud Backup'};
											case 'usb':
												var _v16 = sequence.b;
												var _v17 = _v16.b;
												return {body: 'Für headless Installation: Unterstützung für Plg-and-Play Backup via USB-Stick', title: 'Externer Speicher'};
											default:
												break _v0$15;
										}
									default:
...
var $author$project$Features$Hover = function (a) {
	return {$: 'Hover', a: a};
};
var $elm_community$typed_svg$TypedSvg$Types$PaintNone = {$: 'PaintNone'};
var $author$project$Features$mouseArc = function (s) {
	return $gampleman$elm_visualization$Shape$arc(
		{
			cornerRadius: 0,
			endAngle: s.x + s.width,
			innerRadius: $elm$core$Basics$sqrt(s.y),
			outerRadius: $author$project$Features$radius,
			padAngle: 0,
			padRadius: 0,
			startAngle: s.x
		});
...
var $author$project$Features$mouseInteractionArcs = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Features$Hover($elm$core$Maybe$Nothing))
				]),
			A2(
				$elm$core$List$map,
				function (item) {
					return A2(
						$folkertdev$one_true_path_experiment$Path$element,
						$author$project$Features$mouseArc(item),
						_List_fromArray(
							[
...
var $author$project$Features$wrapWords = F2(
	function (maxLength, str) {
		...
		var foldFunction = F2(
			function (word, _v1) {
				...
				var acc = _v1.b;
				var newLine = $elm$core$String$isEmpty(currentLine) ? word : (currentLine + (' ' + word));
				return (_Utils_cmp(
					$elm$core$String$length(newLine),
					maxLength) < 1) ? _Utils_Tuple2(newLine, acc) : _Utils_Tuple2(
					word,
					_Utils_ap(
						acc,
						_List_fromArray(
...
var $author$project$Features$paragraph = F3(
	function (maxLength, attrs, str) {
		var mkLine = function (l) {
			return A2(
				$elm_community$typed_svg$TypedSvg$tspan,
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Attributes$dy(
						$elm_community$typed_svg$TypedSvg$Types$Num(15)),
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$x(0)
					]),
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Core$text(l)
					]));
		};
		var lines = A2(
			$elm$core$List$map,
			mkLine,
			A2($author$project$Features$wrapWords, maxLength, str));
		return A2($elm_community$typed_svg$TypedSvg$text_, attrs, lines);
	});
...
var $author$project$Features$sunburst = function (model) {
	var hovered = function () {
		var _v3 = model.hovered;
		if (_v3.$ === 'Just') {
			var sequence = _v3.a.sequence;
	...
	var opacity = function (seq) {
		return $elm_community$typed_svg$TypedSvg$Attributes$fillOpacity(
			$elm_community$typed_svg$TypedSvg$Types$Opacity(
				function () {
					var _v2 = model.hovered;
					if (_v2.$ === 'Just') {
						return A2($elm$core$Set$member, seq, hovered);
					} else {
						return true;
					}
				}() ? 0.8 : 0.3));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($elm_community$typed_svg$TypedSvg$Types$Translate, $author$project$Features$radius, $author$project$Features$radius)
					]))
			]),
		_List_fromArray(
			[
				...
				A2(
					...
					function (item) {
						return A2(
							$folkertdev$one_true_path_experiment$Path$element,
							$author$project$Features$arc(item),
							_List_fromArray(
								[
									...
									$elm_community$typed_svg$TypedSvg$Types$Paint(
										A2(
											...
											A2($gampleman$elm_visualization$Scale$convert, model.colorScale, item.node.category)))),
									$elm_community$typed_svg$TypedSvg$Attributes$id(
									'cat-' + A2(
										$elm$core$Maybe$withDefault,
										'',
										$elm$core$List$head(
											$elm$core$List$reverse(item.node.sequence))))
								]));
					},
					model.layout)),
				A2(
				...
				A2(
					...
					function (label) {
						return A2(
							...
							_List_fromArray(
								[
									$elm_community$typed_svg$TypedSvg$Attributes$dy(
									$elm_community$typed_svg$TypedSvg$Types$Num(28))
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$elm_community$typed_svg$TypedSvg$Attributes$href('#cat-' + label),
											$elm_community$typed_svg$TypedSvg$Attributes$startOffset('15%'),
					...
					model.categories)),
				A3($elm$svg$Svg$Lazy$lazy2, $author$project$Features$mouseInteractionArcs, model.layout, model.total),
				function () {
				var _v0 = model.hovered;
				if (_v0.$ === 'Just') {
					var percentage = _v0.a.percentage;
					var sequence = _v0.a.sequence;
					var _v1 = (model.lang === 'de') ? $author$project$Features$featureDescriptionDE(sequence) : $author$project$Features$featureDescription(sequence);
					var title = _v1.title;
					var body = _v1.body;
					return A2(
						$elm_community$typed_svg$TypedSvg$g,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm_community$typed_svg$TypedSvg$Attributes$InPx$fontSize(18),
								...
								A3(
								$author$project$Features$paragraph,
								30,
								_List_fromArray(
									[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, $author$project$Features$w, $author$project$Features$h),
							$elm_community$typed_svg$TypedSvg$Attributes$class(
							_List_fromArray(
								['features-sunburst']))
						]),
					_List_fromArray(
						[
							$author$project$Features$sunburst(data)
						]))
				]));
	} else {
		return $elm_community$typed_svg$TypedSvg$Core$text('loading');
	}
};
var $author$project$Subscribe$ChangeEmail = function (a) {
	return {$: 'ChangeEmail', a: a};
};
var $author$project$Subscribe$Submit = {$: 'Submit'};
...
var $author$project$Subscribe$view = function (model) {
	switch (model.$) {
		case 'Input':
			var v = model.a;
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onSubmit($author$project$Subscribe$Submit)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onInput($author$project$Subscribe$ChangeEmail)
									]),
								_List_Nil),
								A2(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Success, great to have you onboard!')
							]))
					]));
		default:
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Opps, something went wrong')
							]))
					]));
	}
};
var $author$project$Unsubscribe$ChangeEmail = function (a) {
	return {$: 'ChangeEmail', a: a};
};
var $author$project$Unsubscribe$Submit = {$: 'Submit'};
var $author$project$Unsubscribe$view = function (model) {
	switch (model.$) {
		case 'Input':
			var v = model.a;
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Want to get a weekly digest?')
							])),
						A2(
						$elm$html$Html$form,
						_List_fromArray(
							[
								$elm$html$Html$Events$onSubmit($author$project$Unsubscribe$Submit)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$required(true),
										$elm$html$Html$Attributes$value(v),
										$elm$html$Html$Events$onInput($author$project$Unsubscribe$ChangeEmail)
									]),
								_List_Nil),
								A2(
								$elm$html$Html$button,
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Success, feel free to come back any time!')
							]))
					]));
		default:
			return A2(
...
var $author$project$Variants$ChangeSlider = function (a) {
...
var $author$project$Variants$packageTable = F4(
	function (selfHostedSelected, piSelected, saasSelected, overlapping) {
		return _List_fromArray(
			[
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('overlapping', overlapping),
								_Utils_Tuple2('selected', selfHostedSelected)
							]))
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Maximum privacy')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Runs on your computer')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Make backups yourself (iCloud/DropBox/Google Drive)')
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('overlapping', overlapping),
								_Utils_Tuple2('selected', piSelected)
							]))
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Managed Self Host')
							])),
						A2(
						$elm$html$Html$ul,
						_List_Nil,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('You get a microcomputer with Software preinstalled')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Plug it into your Wifi router')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Access from all devices in your home')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Nobody has access from the internet')
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('overlapping', overlapping),
								_Utils_Tuple2('selected', saasSelected)
							]))
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Maximum comfort')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Monthly subscription')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('No installation needed')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Access from everywhere with Internet acess')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Data is stored & backed up in the Cloud')
									]))
							]))
					]))
			]);
	});
var $author$project$Variants$packageTableDE = F4(
	function (selfHostedSelected, piSelected, saasSelected, overlapping) {
		return _List_fromArray(
			[
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Maximaler Datenschutz')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Läuft auf deinem eigenen Computer')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Du machst selber Backups (iCloud/DropBox/Google Drive)')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Du bekommst einen Microcomputer mit vorinstallierter Software')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Einfach an den Router stöpslen, fertig')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Alle Geräte im Haushalt haben Zugriff')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Aber Niemand aus dem Internet')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Maximaler Komfort')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Montaliches Abo')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Keine Software-Installation notwendig')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Zugriff von überall')
									])),
								A2(
								$elm$html$Html$li,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Daten werden in der Cloud gespeichert')
									]))
							]))
					]))
			]);
...
var $author$project$Variants$Cloud = {$: 'Cloud'};
var $author$project$Variants$Datacenter = {$: 'Datacenter'};
var $author$project$Variants$Flashdrive = {$: 'Flashdrive'};
var $author$project$Variants$Laptop = {$: 'Laptop'};
var $author$project$Variants$Micro = {$: 'Micro'};
var $author$project$Variants$Phone = {$: 'Phone'};
var $author$project$Variants$Router = {$: 'Router'};
var $author$project$Variants$allComponents = _List_fromArray(
	[$author$project$Variants$Laptop, $author$project$Variants$Phone, $author$project$Variants$Router, $author$project$Variants$Micro, $author$project$Variants$Cloud, $author$project$Variants$Datacenter, $author$project$Variants$Flashdrive]);
var $author$project$Variants$fCloudDatacenter = _Utils_Tuple2($author$project$Variants$Cloud, $author$project$Variants$Datacenter);
var $author$project$Variants$fLaptopPhone = _Utils_Tuple2($author$project$Variants$Laptop, $author$project$Variants$Phone);
var $author$project$Variants$fLaptopRouter = _Utils_Tuple2($author$project$Variants$Laptop, $author$project$Variants$Router);
var $author$project$Variants$fMicroRouter = _Utils_Tuple2($author$project$Variants$Micro, $author$project$Variants$Router);
var $author$project$Variants$fPhoneCloud = _Utils_Tuple2($author$project$Variants$Phone, $author$project$Variants$Cloud);
var $author$project$Variants$fPhoneRouter = _Utils_Tuple2($author$project$Variants$Phone, $author$project$Variants$Router);
var $author$project$Variants$fRouterCloud = _Utils_Tuple2($author$project$Variants$Router, $author$project$Variants$Cloud);
var $author$project$Variants$allFlows = _List_fromArray(
	[$author$project$Variants$fLaptopPhone, $author$project$Variants$fLaptopRouter, $author$project$Variants$fPhoneRouter, $author$project$Variants$fMicroRouter, $author$project$Variants$fRouterCloud, $author$project$Variants$fPhoneCloud, $author$project$Variants$fCloudDatacenter]);
...
var $author$project$Variants$setup = function (p) {
	switch (p.$) {
		case 'Operator':
			return {
				components: _List_fromArray(
					[$author$project$Variants$Laptop, $author$project$Variants$Phone]),
				flows: _List_fromArray(
					[$author$project$Variants$fLaptopPhone])
			};
		case 'Pi':
			return {
				components: _List_fromArray(
					[$author$project$Variants$Laptop, $author$project$Variants$Phone, $author$project$Variants$Router, $author$project$Variants$Micro]),
				flows: _List_fromArray(
					[$author$project$Variants$fMicroRouter, $author$project$Variants$fLaptopRouter, $author$project$Variants$fPhoneRouter])
			};
		default:
			return {
				components: _List_fromArray(
					[$author$project$Variants$Laptop, $author$project$Variants$Phone, $author$project$Variants$Router, $author$project$Variants$Datacenter, $author$project$Variants$Cloud]),
				flows: _List_fromArray(
					[$author$project$Variants$fLaptopRouter, $author$project$Variants$fRouterCloud, $author$project$Variants$fCloudDatacenter, $author$project$Variants$fPhoneCloud])
			};
	}
};
...
var $author$project$Variants$compSrc = function (c) {
	return '/assets/interactive/' + function () {
		switch (c.$) {
			case 'Datacenter':
				return 'datacenter.svg';
			case 'Flashdrive':
				return 'flashdrive.svg';
			case 'Laptop':
				return 'laptop.svg';
			case 'Micro':
				return 'micro.svg';
...
var $author$project$Variants$inPos = F2(
	function (_package, c) {
		switch (c.$) {
			case 'Cloud':
				return _Utils_Tuple2(0.6, 0.12);
			case 'Datacenter':
				return _Utils_Tuple2(0.8, 0.3);
			case 'Laptop':
				return _Utils_Tuple2(0.05, 0.3);
			case 'Phone':
				if (_package.$ === 'SaaS') {
					return _Utils_Tuple2(0.6, 0.45);
				} else {
					return _Utils_Tuple2(0.3, 0.15);
				}
			case 'Router':
				return _Utils_Tuple2(0.4, 0.3);
			case 'Flashdrive':
				return _Utils_Tuple2(0.5, 0.8);
			default:
				return _Utils_Tuple2(0.18, 0.47);
		}
	});
...
var $author$project$Variants$viewComp = F2(
	function (_package, _v0) {
		var visible = _v0.a;
		var c = _v0.b;
		var opacity = visible ? '1.0' : '0.0';
		var _v1 = A2($author$project$Variants$inPos, _package, c);
		var x = _v1.a;
		var y = _v1.b;
		var translate = $elm_community$typed_svg$TypedSvg$Attributes$transform(
			_List_fromArray(
				[
					A2($elm_community$typed_svg$TypedSvg$Types$Translate, x * 100, y * 100)
				]));
		return A2(
			$elm_community$typed_svg$TypedSvg$image,
			_List_fromArray(
				[
					$elm_community$typed_svg$TypedSvg$Attributes$href(
					$author$project$Variants$compSrc(c)),
					$elm_community$typed_svg$TypedSvg$Attributes$width(
					$elm_community$typed_svg$TypedSvg$Types$Num(23)),
					$elm_community$typed_svg$TypedSvg$Attributes$height(
					$elm_community$typed_svg$TypedSvg$Types$Num(23)),
					A2($elm$html$Html$Attributes$style, 'opacity', opacity),
					A2($elm$html$Html$Attributes$style, 'filter', 'url(#shadow)'),
					$elm_community$typed_svg$TypedSvg$Attributes$x(
					$elm_community$typed_svg$TypedSvg$Types$Num(x * 100.0)),
					$elm_community$typed_svg$TypedSvg$Attributes$y(
					$elm_community$typed_svg$TypedSvg$Types$Num(y * 100.0))
				]),
			_List_Nil);
	});
var $elm_community$typed_svg$TypedSvg$Attributes$d = $elm_community$typed_svg$TypedSvg$Core$attribute('d');
var $author$project$Variants$halfCompSize = 0.23 * 0.5;
var $author$project$Variants$svgPos = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return $elm$core$String$fromFloat((x + $author$project$Variants$halfCompSize) * 100.0) + (' ' + $elm$core$String$fromFloat(($author$project$Variants$halfCompSize + y) * 100.0));
};
var $author$project$Variants$svgPrefixed = function (_v0) {
	var p = _v0.a;
	var pos = _v0.b;
	return p + (' ' + $author$project$Variants$svgPos(pos));
};
var $author$project$Variants$dElem = function (es) {
	return $elm_community$typed_svg$TypedSvg$Attributes$d(
		A2(
			$elm$core$String$join,
			' ',
			A2($elm$core$List$map, $author$project$Variants$svgPrefixed, es)));
};
...
var $author$project$Variants$viewFlow = F2(
	function (_package, _v0) {
		var visible = _v0.a;
		var _v1 = _v0.b;
		var from = _v1.a;
		var to = _v1.b;
		var toPos = A2($author$project$Variants$inPos, _package, to);
		var fromPos = A2($author$project$Variants$inPos, _package, from);
		var _v2 = toPos;
		var tx = _v2.a;
		var ty = _v2.b;
		var _v3 = fromPos;
		var fx = _v3.a;
		var fy = _v3.b;
		var _v4 = (_Utils_cmp(ty, fy) < 0) ? _Utils_Tuple2(
			_Utils_Tuple2(tx, fy),
			_Utils_Tuple2(fx, ty)) : _Utils_Tuple2(
			_Utils_Tuple2(tx, fy),
			_Utils_Tuple2(fx, ty));
		var c1 = _v4.a;
		var c2 = _v4.b;
		var pth = function (dir) {
			return A2(
				$elm_community$typed_svg$TypedSvg$path,
				_List_fromArray(
					[
						$author$project$Variants$dElem(
						_List_fromArray(
							[
								_Utils_Tuple2('M', fromPos),
								_Utils_Tuple2('C', c1),
								_Utils_Tuple2(',', c2),
								_Utils_Tuple2(',', toPos)
							])),
						...
						$elm_community$typed_svg$TypedSvg$Types$px(0.3)),
						$elm_community$typed_svg$TypedSvg$Attributes$stroke(
						$elm_community$typed_svg$TypedSvg$Types$Paint(
							dir ? A4($avh4$elm_color$Color$rgba, 0.8, 0, 0, 1.0) : A4($avh4$elm_color$Color$rgba, 0, 0.8, 0.8, 1.0))),
						$elm_community$typed_svg$TypedSvg$Attributes$opacity(
						$elm_community$typed_svg$TypedSvg$Types$Opacity(
							visible ? 1.0 : 0.0)),
						dir ? $elm_community$typed_svg$TypedSvg$Attributes$transform(
						_List_fromArray(
							[
								A2($elm_community$typed_svg$TypedSvg$Types$Translate, 1.0, 1.0)
							])) : $elm_community$typed_svg$TypedSvg$Attributes$transform(_List_Nil)
					]),
				_List_Nil);
		};
		return A2(
...
var $author$project$Variants$flowsView = function (_package) {
	var house = A2(
		$elm_community$typed_svg$TypedSvg$image,
		_List_fromArray(
			[
				$elm_community$typed_svg$TypedSvg$Attributes$href('/assets/interactive/house.svg'),
				$elm_community$typed_svg$TypedSvg$Attributes$width(
				$elm_community$typed_svg$TypedSvg$Types$Num(120)),
				$elm_community$typed_svg$TypedSvg$Attributes$height(
				$elm_community$typed_svg$TypedSvg$Types$Num(120)),
				A2($elm$html$Html$Attributes$style, 'opacity', '0.2'),
				$elm_community$typed_svg$TypedSvg$Attributes$x(
				$elm_community$typed_svg$TypedSvg$Types$Num(-50)),
				$elm_community$typed_svg$TypedSvg$Attributes$y(
				$elm_community$typed_svg$TypedSvg$Types$Num(-40))
			]),
		_List_Nil);
	var defs = A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Attributes$id('shadow')
					]),
				_List_fromArray(
					[
						A3(
						$elm_community$typed_svg$TypedSvg$Core$node,
						'feDropShadow',
						_List_fromArray(
							[
								$elm_community$typed_svg$TypedSvg$Attributes$dx(
								$elm_community$typed_svg$TypedSvg$Types$Num(1)),
								$elm_community$typed_svg$TypedSvg$Attributes$dy(
								$elm_community$typed_svg$TypedSvg$Types$Num(1)),
								$elm_community$typed_svg$TypedSvg$Attributes$stdDeviation('0.9'),
								A2($elm_community$typed_svg$TypedSvg$Core$attribute, 'flood-opacity', '0.3')
							]),
						_List_Nil)
					]))
			]));
	var _v0 = $author$project$Variants$setup(_package);
	var components = _v0.components;
	var flows = _v0.flows;
	var compsWithVisibility = A2(
		$elm$core$List$map,
		function (c) {
			return _Utils_Tuple2(
				A2($elm$core$List$member, c, components),
				c);
		},
		$author$project$Variants$allComponents);
	var flowsWithVisibility = A2(
		$elm$core$List$map,
		function (f) {
			return _Utils_Tuple2(
				A2($elm$core$List$member, f, flows),
				f);
		},
		$author$project$Variants$allFlows);
	return A2(
		$elm_community$typed_svg$TypedSvg$svg,
		_List_fromArray(
			[
				A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 15, 100, 50),
				$elm_community$typed_svg$TypedSvg$Attributes$class(
				_List_fromArray(
					['flows']))
			]),
		A2(
			...
			A2(
				...
				_Utils_ap(
					A2(
						$elm$core$List$map,
						$author$project$Variants$viewFlow(_package),
						flowsWithVisibility),
					A2(
						$elm$core$List$map,
						$author$project$Variants$viewComp(_package),
						compsWithVisibility)))));
};
var $author$project$Variants$viewComps = function (_package) {
	return A2(
		$elm$html$Html$p,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('components foo5')
			]),
		_List_fromArray(
			[
				$author$project$Variants$flowsView(_package)
			]));
};
var $author$project$Variants$view = function (model) {
	var sliderPos = function () {
		var _v1 = model._package;
		switch (_v1.$) {
			case 'Operator':
				return '0';
			case 'Pi':
	...
	var selfHostedSelected = _Utils_eq(model._package, $author$project$Variants$Operator);
	var saasSelected = _Utils_eq(model._package, $author$project$Variants$SaaS);
	var piSelected = function () {
	...
	var pt = (model.lang === 'de') ? A3($author$project$Variants$packageTableDE, selfHostedSelected, piSelected, saasSelected) : A3($author$project$Variants$packageTable, selfHostedSelected, piSelected, saasSelected);
	return A2(
		$elm$html$Html$section,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$Variants$viewComps(model._package),
				A2(
				$elm$html$Html$p,
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$value(sliderPos),
								$elm$html$Html$Attributes$min('0'),
								$elm$html$Html$Attributes$max('2'),
								$elm$html$Html$Events$onInput($author$project$Variants$ChangeSlider)
							]),
						_List_Nil),
						A2(
						$elm$html$Html$div,
...
var $author$project$Interactive$view = function (model) {
	switch (model.$) {
		case 'OnVariants':
			var model_ = model.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Interactive$ForVariants,
				$author$project$Variants$view(model_));
		case 'OnFeatureTree':
			var model_ = model.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Interactive$ForFeatureTree,
				$author$project$FeatureTree$view(model_));
		case 'OnFeatures':
			var model_ = model.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Interactive$ForFeatures,
				$author$project$Features$view(model_));
		case 'OnSubscribe':
			var model_ = model.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Interactive$ForSubscribe,
				$author$project$Subscribe$view(model_));
		default:
			var model_ = model.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Interactive$ForUnsubscribe,
				$author$project$Unsubscribe$view(model_));
	}
};
var $author$project$Interactive$main = $elm$browser$Browser$element(
	{init: $author$project$Interactive$init, subscriptions: $author$project$Interactive$subscriptions, update: $author$project$Interactive$update, view: $author$project$Interactive$view});
_Platform_export({'Interactive':{'init':$author$project$Interactive$main($elm$json$Json$Decode$value)(0)}});}(this));